...
export default function LandingPage() {
  return (
    <div className="min-h-screen">
      {/* Hero */}
      <section className="bg-linear-to-b from-slate-900 via-slate-800 to-indigo-900 text-white relative overflow-hidden py-32">
        <div className="absolute inset-0 bg-[url(%22data:image/svg+xml,%3Csvg%20width='40'%20height='40'%20viewBox='0%200%2040%2040'%20xmlns='http://www.w3.org/2000/svg'%3E%3Cg%20fill='none'%20fill-rule='evenodd'%3E%3Cg%20fill='%23ffffff'%20fill-opacity='0.1'%3E%3Crect%20width='1'%20height='1'%20x='0'%20y='19'/%3E%3Crect%20width='19'%20height='1'%20x='0'%20y='0'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E')] opacity-10"></div>
        <div className="max-w-6xl mx-auto px-4 relative z-10 text-center">
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-black bg-linear-to-r from-white via-indigo-100 to-white bg-clip-text text-transparent mb-8 leading-tight">
            NitiNova
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-16">
            <Link href="/register">
              <Button className="text-2xl px-12 py-8 shadow-2xl hover:shadow-3xl">
                Start Free Trial
              </Button>
            </Link>
            <Link href="/demo">
              <Button variant="secondary" className="text-2xl px-12 py-8 border-2 border-white/30 backdrop-blur-sm">
                Live Demo
              </Button>
            </Link>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4 p-6 bg-yellow-50 border border-yellow-200 rounded-2xl">
                  <div className="w-12 h-12 bg-yellow-100 rounded-xl flex items-center justify-center shrink-0 mt-0.5">
                    <span className="text-xl">❌</span>
                  </div>
                  <div>
            ...
            <div className="relative">
              <div className="bg-linear-to-r from-indigo-500/5 to-blue-500/5 rounded-3xl p-12 border border-indigo-200/50 backdrop-blur-sm shadow-2xl">
                <img src="/judgment-mockup.png" alt="Case Structure" className="w-full max-w-md mx-auto rounded-2xl shadow-2xl" />
                <div className="absolute -top-6 -right-6 w-32 h-32 bg-linear-to-r from-indigo-400 to-blue-400 rounded-full opacity-20 blur-xl"></div>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Solution */}
      <section className="py-24 bg-gradient-linear-to-b from-slate-50 to-white">
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-20">
            <h2 className="text-4xl md:text-5xl font-black bg-linear-to-r from-indigo-600 to-blue-600 bg-clip-text text-transparent mb-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="group hover:scale-[1.02] transition-transform">
              <div className="text-center p-12 border-2 border-indigo-100 rounded-3xl bg-linear-to-b from-white to-indigo-50/30 hover:shadow-2xl hover:border-indigo-300">
                <div className="w-20 h-20 bg-linear-to-r from-indigo-500 to-blue-500 rounded-3xl flex items-center justify-center mx-auto mb-8 shadow-2xl text-white text-2xl">
                  📁
                </div>
                ...
                <div className="w-full h-1 bg-indigo-200 rounded-full">
                  <div className="h-1 bg-linear-to-r from-indigo-500 to-blue-500 rounded-full w-3/4 animate-pulse"></div>
                </div>
              </div>
            </div>
            <div className="group hover:scale-[1.02] transition-transform">
              <div className="text-center p-12 border-2 border-emerald-100 rounded-3xl bg-linear-to-b from-white to-emerald-50/30 hover:shadow-2xl hover:border-emerald-300">
                <div className="w-20 h-20 bg-linear-to-r from-emerald-500 to-green-500 rounded-3xl flex items-center justify-center mx-auto mb-8 shadow-2xl text-white text-2xl">
                  🧠
                </div>
                ...
                <div className="w-full h-1 bg-emerald-200 rounded-full">
                  <div className="h-1 bg-linear-to-r from-emerald-500 to-green-500 rounded-full w-full"></div>
                </div>
              </div>
            </div>
            <div className="group hover:scale-[1.02] transition-transform">
              <div className="text-center p-12 border-2 border-blue-100 rounded-3xl bg-linear-to-b from-white to-blue-50/30 hover:shadow-2xl hover:border-blue-300">
                <div className="w-20 h-20 bg-linear-to-r from-blue-500 to-indigo-500 rounded-3xl flex items-center justify-center mx-auto mb-8 shadow-2xl text-white text-2xl">
                  🔍
                </div>
                ...
                <div className="w-full h-1 bg-blue-200 rounded-full">
                  <div className="h-1 bg-linear-to-r from-blue-500 to-indigo-500 rounded-full w-full"></div>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* Demo Preview */}
      <section className="py-24 bg-gradient-linear-to-b from-slate-900 to-slate-800 text-white">
            ...
            <div className="lg:w-1/2 text-left lg:text-lg">
              ...
              <ul className="space-y-4 mb-12">
                <li className="flex items-start gap-4 p-4 bg-white/10 rounded-2xl backdrop-blur-sm">
                  <span className="w-8 h-8 bg-green-400/20 rounded-xl flex items-center justify-center font-bold text-green-400 text-lg mt-0.5 shrink-0">1</span>
                  <span>Upload judgment PDF</span>
                </li>
                <li className="flex items-start gap-4 p-4 bg-white/10 rounded-2xl backdrop-blur-sm">
                  <span className="w-8 h-8 bg-green-400/20 rounded-xl flex items-center justify-center font-bold text-green-400 text-lg mt-0.5 shrink-0">2</span>
                  <span>AI extracts Facts • Issues • Ratio in seconds</span>
                </li>
                <li className="flex items-start gap-4 p-4 bg-white/10 rounded-2xl backdrop-blur-sm">
                  <span className="w-8 h-8 bg-green-400/20 rounded-xl flex items-center justify-center font-bold text-green-400 text-lg mt-0.5 shrink-0">3</span>
                  <span>Semantic search finds perfect precedents</span>
                </li>
              </ul>
              <Link href="/demo" className="inline-block bg-linear-to-r from-indigo-600 to-blue-600 hover:from-indigo-700 hover:to-blue-700 text-white px-12 py-6 rounded-2xl font-bold text-xl shadow-2xl hover:shadow-3xl transition-all">
      ...
      {/* CTA */}
      <section className="py-24 bg-gradient-linear-to-r from-indigo-600 via-blue-600 to-purple-600 text-white">
